				...
				<div class="ibox">
					<div class="ibox-title" style="padding:5px;">
						...
						<span class="pull-right">
							<a href="../teamstats/index.cfm?event=dashboard" style="margin-right:5px;margin-bottom:5px;" class="btn btn-sm btn-success"><i class="fa fa-lock"></i> Login for Team QwikStats</a>
