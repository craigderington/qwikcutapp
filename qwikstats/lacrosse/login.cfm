			...
			<body class="gray-bg">
				...
				<div class="middle-box text-center loginscreen animated fadeInDown">
					<div>
						...
						<h3 class="text-primary">QwikStats: Video and Analytics</h3>
						<p class="text-success">Login required to view team stats and anlystics.</p>

						<form class="m-t" role="form" action="" method="post" disabled>
