	...
	<cffunction
		...
		hint="Fires when the application is first created.">	
		 ...
		 <cfscript>
			...
			application.title = "QwikStats:  Team Statistics";
					...
					<cfelse>						
						<cfquery name="loginquery">
							select u.userid, u.username, u.password, u.confid, u.firstname, u.lastname,
								   u.userrole, u.useracl, u.useractive, u.stateid, u.teamname
							  from dbo.users u
						...
						<cfif loginquery.userid NEQ "">												
								...
								<cfquery name="getteamdata">
									select distinct(teamid)
									  from lacrosse_stats 
									 where teamname = <cfqueryparam value="#loginquery.teamname#" cfsqltype="cf_sql_varchar" />
