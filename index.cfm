...
<head>
    ...
    <title>QwikCut Game Day App</title>
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Shooter Alpha1</strong>
                             </span> <span class="text-muted text-xs block">Videographer <b class="caret"></b></span> </span> </a>
