						...
						<cfoutput>
							<div class="ibox">				
								<div class="ibox-title">
									<h5><i class="fa fa-play-circle"></i> Create Custom Game Matchups</h5>
									<span class="pull-right">									
										<a href="#application.root##url.event#&fuseaction=game.add" class="btn btn-xs btn-success btn-outline"><i class="fa fa-arrow-circle-left"></i> Return to Game Scheduler</a>
