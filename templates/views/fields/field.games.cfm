						...
						<div class="ibox-content">			
							<div class="tabs-container">
								<ul class="nav nav-tabs">
									...
									<li class="active"><a href="#application.root##url.event#&fuseaction=field.games&id=#url.id#"><i class="fa fa-play"></i> Scheduled Games</a></li>
								...
								<div class="tab-content">
									<div id="tab-1" class="tab-pane active">
										<div class="panel-body">
											<div class="col-md-12">
												<cfinclude template="field-games-view.cfm">
											</div>
										</div>
									</div>
								</div>						
