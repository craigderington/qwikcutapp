					...
					<div class="row">
						<div class="ibox">					
							<div class="ibox-title">
								<h5><i class="fa fa-video-camera"></i> Shooter | Assigned Fields | #shooter.shooterfirstname# #shooter.shooterlastname#   <cfif isuserinrole( "admin" )><a href="#application.root##url.event#&fuseaction=shooter.edit&id=#shooter.shooterid#" class="btn btn-xs btn-primary btn-outline" style="margin-left:15px;"><i class="fa fa-edit"></i> Edit Shooter</a></cfif></h5>
							...
							<div class="ibox-content">									
								...
								<div class="tabs-container">
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="#application.root##url.event#&fuseaction=shooter.fields&id=#url.id#"><i class="fa fa-map-marker"></i> Assigned Fields</a></li>
									...
									<div class="tab-content">
										<div id="tab-1" class="tab-pane active">
											<div class="panel-body">
												<div class="col-md-6">																								
													<cfinclude template="shooter-fields-list.cfm">													
												</div>
												<div class="col-md-6">
													<cfinclude template="shooter-fields-form.cfm">
												</div>
											</div>
										</div>											
									</div><!-- / .tab-content -->
