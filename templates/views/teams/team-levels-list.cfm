										...
										<div class="form-group">
											...
											<select name="conferenceid" id="conferenceid" class="form-control" onchange="javascript:this.form.submit();">
												...
												<cfloop query="conferencelist">
													<option value="#confid#"<cfif structkeyexists( form, "conferenceid" )><cfif form.conferenceid eq conferencelist.confid>selected</cfif><cfelseif structkeyexists( session, "conferenceid" )><cfif session.conferenceid eq conferencelist.confid>selected</cfif><cfelseif not structkeyexists( form, "confid" ) and not structkeyexists( session, "conferenceid" ) and conferencelist.confid eq 1>selected</cfif>>#confname#</option>
												</cfloop>
											</select>
										</div>
									</div>
