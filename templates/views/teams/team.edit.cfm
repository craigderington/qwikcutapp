						...
						<div class="ibox-title">							
							<h5><i class="fa fa-edit"></i> Edit Team Details | #teamdetail.teamname# </h5>							
								<span class="pull-right">
									...
									<a style="margin-right:5px;" href="#application.root##url.event#&fuseaction=teams.view" class="btn btn-xs btn-default btn-outline"><i class="fa fa-trophy"></i> Teams by Conference</a>
								</span>
						</div>
