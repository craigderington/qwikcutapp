					...
					<div class="ibox" style="margin-top:-15px;">								
						...
						<div class="ibox-content" style="min-height:500px;">
							...
							<ul class="nav nav-tabs">
									...
									<li class="active"><a href="#application.root##url.event#&fuseaction=team.contacts&id=#url.id#"><i class="fa fa-briefcase"></i> Team Contacts</a></li>
								...
								<div class="tab-content" style="margin-top:25px;">
								    <div id="teamcontacts" class="tab-pane fade in active">						
									<div class="col-lg-8">
