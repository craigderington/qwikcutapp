<cfcomponent displayname="notificationservice">
	...
	<cffunction name="sendshooterinvite" access="public" output="false" returntype="any" hint="I send the shooter registration email.">
		...
		<cfset arguments.senderemail = "QwikCut App(systems@qwikcut.com)"  />
		<cfset msgstatus = "" />
			<cfmail from="#arguments.senderemail#" to="#arguments.shooteremail#" subject="QwikCut - Videographer Registration - Action Required" type="HTML"><cfoutput><div align="center"><a href="http://www.qwikcut.com"><img src="http://qwikcut.cloudapp.net/img/qc-logo-600x176.jpg" height="176" width="600"></a></div>
...
<p><a href="http://qwikcut.cloudapp.net/register/index.cfm?beginregistration=true&regcode=#arguments.shooterregcode#&email=#arguments.shooteremail#" style="-moz-box-shadow:inset 0px 1px 0px 0px ##9acc85;-webkit-box-shadow:inset 0px 1px 0px 0px ##9acc85;box-shadow:inset 0px 1px 0px 0px ##9acc85;background:-webkit-gradient(linear, left top, left bottom, color-stop(0.05, ##74ad5a), color-stop(1, ##68a54b));background:-moz-linear-gradient(top, ##74ad5a 5%, ##68a54b 100%);background:-webkit-linear-gradient(top, ##74ad5a 5%, ##68a54b 100%);background:-o-linear-gradient(top, ##74ad5a 5%, ##68a54b 100%);background:-ms-linear-gradient(top, ##74ad5a 5%, ##68a54b 100%);background:linear-gradient(to bottom, ##74ad5a 5%, ##68a54b 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='##74ad5a', endColorstr='##68a54b',GradientType=0);background-color:##74ad5a;-moz-border-radius:11px;-webkit-border-radius:11px;border-radius:11px;border:3px solid ##3b6e22;display:inline-block;cursor:pointer;color:##ffffff;font-family:Verdana;font-size:18px;font-weight:bold;padding:10px 21px;text-decoration:none;text-shadow:0px 1px 0px ##92b879;"> Complete Videographer Registration</a></p>	
